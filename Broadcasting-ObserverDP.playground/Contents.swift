...
protocol Observer {
    func notify()
    // let us compare objects that implemented the protocol when managing the observers
    var uid: Int { get }
}

//to subscribe for notification
protocol Subject {
    mutating func register(_ observer: Observer)
    mutating func unregister(_ observer: Observer)
}

//UIButton is the subject, UILabel is the observers
...
extension UILabel: Observer {
    ...
    var uid: Int {
        ...
        //ObjectIdentifier works in ref-type not value-type
    }
}

extension UIButton: Subject {
    //to keep track observers
...
class MyViewController: UIViewController {
    ...
    override func loadView() {
        ...
        unregisterButton.setTitle("Unergister Observer", for: .normal)
